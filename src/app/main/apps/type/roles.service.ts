...
import { Role } from 'app/main/apps/type/role.model';
...
export class RolesService implements Resolve<any>
{
    ...
    getRoles(): Promise<any>
    {
        ...
        return new Promise((resolve, reject) => {
                ...
                this._httpClient.get(`${environment.apiUrl}/type`,this.httpOptions)
     ...
     */
     ...
     {  
        ...
        this.onRolesChanged.next(this.roles);
        return this._httpClient.delete<any>(`${environment.apiUrl}/type/`+role.id,this.httpOptions);
    ...
    deleteSelectedRoles()
    {
        ...
        return  this._httpClient.post<any>(`${environment.apiUrl}/type/delete`,
   ...
   { 
        ...
        return this._httpClient.post<any>(`${environment.apiUrl}/type`,role ,this.httpOptions);
   }

   
   editRole(role,roleForm)
   { 
        this.ldata = JSON.parse(localStorage.getItem('currentUser'));
        this.httpOptions = {
           headers: new HttpHeaders({
        ...
        return this._httpClient.put<any>(`${environment.apiUrl}/type/`+roleForm.id,role ,this.httpOptions);
   }
