...
import { Role } from 'app/main/apps/audience/role.model';
...
export class RolesService implements Resolve<any>
{
    ...
    getRoles(): Promise<any>
    {
        ...
        return new Promise((resolve, reject) => {
                ...
                this._httpClient.get(`${environment.apiUrl}/audience`,this.httpOptions)
     ...
     */
     ...
     {  
        ...
        this.onRolesChanged.next(this.roles);
        return this._httpClient.delete<any>(`${environment.apiUrl}/audience/`+role.id,this.httpOptions);
    ...
    deleteSelectedRoles()
    {
        ...
        return  this._httpClient.post<any>(`${environment.apiUrl}/audience/delete`,
   ...
   { 
        ...
        return this._httpClient.post<any>(`${environment.apiUrl}/audience`,role ,this.httpOptions);
   }
   ...
   { 
        ...
        return this._httpClient.put<any>(`${environment.apiUrl}/audience/`+role.id,role ,this.httpOptions);
   }
