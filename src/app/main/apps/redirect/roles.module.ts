...
import { RolesComponent } from 'app/main/apps/redirect/roles.component';
import { RolesService } from 'app/main/apps/redirect/roles.service';
import { RolesRoleListComponent } from 'app/main/apps/redirect/role-list/role-list.component';
import { RolesSelectedBarComponent } from 'app/main/apps/redirect/selected-bar/selected-bar.component';
import { RolesRoleFormDialogComponent } from 'app/main/apps/redirect/role-form/role-form.component';
import { RolesMainSidebarComponent } from 'app/main/apps/redirect/sidebars/main/main.component';
