...
import { Role } from 'app/main/apps/redirect/role.model';
...
export class RolesService implements Resolve<any>
{
    ...
    getRoles(): Promise<any>
    {
        ...
        return new Promise((resolve, reject) => {
                ...
                this._httpClient.get(`${environment.apiUrl}/redirect`,this.httpOptions)
     ...
     */
     ...
     {  
        ...
        this.onRolesChanged.next(this.roles);
        return this._httpClient.delete<any>(`${environment.apiUrl}/redirect/`+role.id,this.httpOptions);
    ...
    deleteSelectedRoles()
    {
        ...
        return  this._httpClient.post<any>(`${environment.apiUrl}/redirect/delete`,
   ...
   { 
        ...
        return this._httpClient.post<any>(`${environment.apiUrl}/redirect`,redirect ,this.httpOptions);
   }
   ...
   { 
        ...
        return this._httpClient.put<any>(`${environment.apiUrl}/redirect/`+role.id,role ,this.httpOptions);
   }
