...
export class RolesService implements Resolve<any>
{
    ...
    getRoles(): Promise<any>
    {
        ...
        return new Promise((resolve, reject) => {
                ...
                this._httpClient.get(`${environment.apiUrl}/role`,this.httpOptions)
     ...
     */
     ...
     {  
        ...
        this.onRolesChanged.next(this.roles);
        return this._httpClient.delete<any>(`${environment.apiUrl}/role/`+role.id,this.httpOptions);
    ...
    deleteSelectedRoles()
    {
        ...
        return  this._httpClient.post<any>(`${environment.apiUrl}/role/delete`,
   ...
   { 
        ...
        return this._httpClient.post<any>(`${environment.apiUrl}/role`,role ,this.httpOptions);
   }
   ...
   { 
        ...
        return this._httpClient.put<any>(`${environment.apiUrl}/role/`+role.id,role ,this.httpOptions);
   }
